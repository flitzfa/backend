...
Por ejemplo, el día 11 de Abril del 2023 corrí los tests, se generó **`TestResults_2023-04-11.txt`** en la carpeta `testresults`

```console
cat testresults/TestResults_2023-04-11.txt
